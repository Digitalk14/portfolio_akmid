...
export const PROJECTS_LIST: IPROJECTS_LISTProps[] = [
    {
        ...
        description: 'inDrive is an international Internet aggregator of passenger, freight and intercity transportation services.'
    },
    {
        imgUrl: '/assets/images/projects/sinet-team.jpg',
        title: {
            name: 'sinet.team',
            role: 'Frontend Engineer',
